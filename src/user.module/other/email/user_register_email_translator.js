    ...
    switch (true) {
        case (lang === 'es'):
            language = {
                ...
                info1: 'Recibes este correo electrónico porque has iniciado el proceso de registración. Si tienes dudas, completa el formulario de contacto, o bien envíanos un email a info@LOGO.com.',
                subject1: 'Hola',
        ...
        default: 
            language = {
                ...
                text6: 'LOGO team',
                info1: 'You are receiving this email because you have started the registration process. If you have questions, complete the contact form, or send us an email to info@LOGO.com.',
                subject1: 'Hello',
